...
3. Test LLM query (requires Ollama running)

### Test Individual Functions

```python
from llm_backend import detect_query_language, ask_llm_intent

# Test language detection
print(detect_query_language("كيف اجدد الرخصة"))  # Should output: 'ar'
print(detect_query_language("How to renew"))     # Should output: 'en'

# Test LLM (requires Ollama)
result = ask_llm_intent("كيف اجدد رخصة القيادة")
print(result)
```
