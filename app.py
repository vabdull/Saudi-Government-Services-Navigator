"""
Saudi Government Services Navigator - Main Application

A bilingual (Arabic/English) Streamlit web application that helps users find
Saudi government services using AI-powered natural language processing.

Features:
    - Bilingual support (Arabic RTL / English LTR)
    - AI-powered service classification using local LLM
    - Modern chat-style interface
    - Saudi government themed design
...
MAIN_BG = "#F8F6EF"       # Warm beige background
INPUT_BG = "#E4DECF"      # Beige for input fields
ABS_GREEN = "#006C35"     # Official Saudi green
LIGHT_GREEN = "#B9D7C4"   # Light green for borders
TEXT_COLOR = "#006C35"    # Green text color
GRAY_TEXT = "#5a8a6a"     # Muted green for secondary text
